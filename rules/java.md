# Java Rules
*Stack-specific rules for Java projects*
...
- **Records**: Use records for immutable data carriers
- **Pattern-Switch**: Use pattern matching in switch
- **Virtual-Threads**: Use virtual threads for high-concurrency I/O
