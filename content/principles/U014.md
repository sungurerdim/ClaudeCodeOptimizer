...
# U014: Explicit Completion Criteria 🔴
...
**Trigger**: EVERY TODO creation (works with U013)
...
## Integration with U013

**U013** (Change Verification): Verifies code changes are complete
**U014** (Completion Criteria): Verifies TASK is complete per requirements

**Together**:
1. U013: Find all affected files → create TODOs
2. U014: Each TODO has explicit completion criteria
3. U013: Verify each change (grep, tests)
4. U014: Verify criteria met before "completed"
...
- **U001** (Evidence-Based Verification): Provides evidence, U014 defines what evidence is needed
- **U013** (Change Verification Protocol): Verifies changes, U014 verifies task completion
- **U003** (Test-First Development): Tests are completion criteria for features
