...
# U013: Change Verification Protocol 🔴
...
**Use with**:
- U001 (Evidence-Based Verification) - grep output is evidence
- U004 (Root Cause Analysis) - trace changes to source
- P002 (Complete Integration Check) - no orphaned code
