...
<details>
<summary><b>Rules System (1674 rules)</b></summary>

| Category | Count | When Loaded                     |
|----------|-------|---------------------------------|
| Core     | 77    | Always (fundamental principles) |
| AI       | 42    | Always (behavior patterns)      |
| Adaptive | 1555  | Per-project (stack-specific)    |
