...
CCO uses a 4-category rules system with **1491 rules total**:
...
| **Adaptive** | 1284 | Selected per project → `.claude/rules/cco/` |
...
- **Adaptive** - Stack-based: 26 languages, 100+ frameworks, 43 dependency categories
...
| [Rules Directory][memory] | 4-category rule system (1491 rules) |
