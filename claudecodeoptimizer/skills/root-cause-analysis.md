...
- Pattern: All added before 2024-01-01 (P001 adoption date)
...
**Systemic Fix:**
```
1. Create migration script: /cco-migrate-legacy --principle=P001
...
2. Share DRY principle (P002) documentation
...
1. PRIMARY: Legacy Code (80% of violations)
   ...
   - Before team adopted P001 principle
...
[ ] Create migration script: /cco-migrate-legacy --principle=P001
...
3. Update onboarding docs: Include P001 principle
...
Violation Type: Hardcoded Secrets (P019)
...
User: "Yes"
Skill: "Running /cco-migrate-legacy --principle=P001..."
