...
2. Or manually link:
   ...
   # Unix/Linux/Mac
   ln -s ~/.cco/knowledge/skills/my-skill.md .claude/skills/my-skill.md
   ```
...
Custom skills in `~/.cco/knowledge/skills/` are:
...
2. Team members copy to their `~/.cco/knowledge/skills/`
